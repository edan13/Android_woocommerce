...
public class PrinterSettingActivity extends Activity
        implements View.OnClickListener, MaintenanceCounterListener, PrinterSettingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<SpnModelsItem>
                printSpeedAdapter = new ArrayAdapter<SpnModelsItem>(this, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<SpnModelsItem>
                printDensityAdapter = new ArrayAdapter<SpnModelsItem>(this, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<SpnModelsItem>
                paperWidthAdapter = new ArrayAdapter<SpnModelsItem>(this, android.R.layout.simple_spinner_item);
        ...
        if(MainPrinterActivity.mEditTarget.getText().toString().contains("[")) {
    ...
    protected boolean reconnect(int maxWait, int interval) {
        ...
        do {
            try {
                mPrinter.connect(MainPrinterActivity.mEditTarget.getText().toString(), interval * 1000);
                break;
            }
            catch (Exception e) {
            }
    ...
    private boolean initializeObject() {
        try {
            mPrinter = new Printer(((SpnModelsItem) MainPrinterActivity.mSpnSeries.getSelectedItem()).getModelConstant(),
                    ((SpnModelsItem) MainPrinterActivity.mSpnLang.getSelectedItem()).getModelConstant(),
                    mContext);
        }
        catch (Exception e) {
    ...
    protected boolean connectPrinter(){
        ...
        try {
            mPrinter.connect(
                    MainPrinterActivity.mEditTarget.getText().toString(), Printer.PARAM_DEFAULT);
        }
        catch (Exception e) {
